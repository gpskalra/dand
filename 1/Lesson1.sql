###Limits
/*
Limit to only 15 rows and includes the date, account_id
and channel fields from the web_events table
*/
...
*/
SELECT id, account_id, standard_amt_usd/standard_qty AS standard_unitprice_usd
FROM orders
LIMIT 10;
/*
...
You will learn how to get a solution without an error to this query when you learn about CASE statements in a later section. For now, you might just add some very small value to your denominator as a work around.
*/
SELECT id,
       account_id,
       poster_amt_usd*100/(standard_amt_usd + gloss_amt_usd + poster_amt_usd + 0.01) AS poster_revenue_percent
FROM orders;

###Like
/*
This is a soft match vs an exact match.
In some cases where you might not know the exact values of the data, a soft match is more useful.
*/
/*
